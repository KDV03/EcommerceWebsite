        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerRating = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FundsHeld = table.Column<bool>(type: "bit", nullable: false),
                    FundsReleasedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AutoReleaseEnabled = table.Column<bool>(type: "bit", nullable: false),
                    AutoReleaseDays = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserDocuments_AspNetUsers_ReviewedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Disputes_AspNetUsers_InitiatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderStatusHistory", x => x.StatusId);
                    table.ForeignKey(
                        name: "FK_OrderStatusHistory_AspNetUsers_UpdatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentGatewayReference = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ProcessedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EscrowReleaseDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerResponse = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Electronic devices and accessories", null, true, "Electronics" },
                    { 2, "Fashion and apparel", null, true, "Clothing" },
                    { 3, "Physical and digital books", null, true, "Books" },
                    { 4, "Home improvement and garden supplies", null, true, "Home & Garden" },
                    { 5, "Sports equipment and outdoor gear", null, true, "Sports & Outdoors" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "CreatedDate", "Description", "DiscountPercentage", "ImageUrl", "IsActive", "ModifiedDate", "Name", "Price", "SKU", "StockQuantity" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2026, 2, 9, 8, 40, 1, 444, DateTimeKind.Utc).AddTicks(5336), "Premium noise-cancelling wireless headphones with 30-hour battery life", 15m, "/images/products/headphones.jpg", true, null, "Wireless Bluetooth Headphones", 89.99m, "ELEC-WH-001", 45 },
                    { 2, 1, new DateTime(2026, 2, 9, 8, 40, 1, 444, DateTimeKind.Utc).AddTicks(5339), "Experience stunning picture quality with HDR and smart features", null, "/images/products/tv.jpg", true, null, "4K Ultra HD Smart TV 55\"", 599.99m, "ELEC-TV-002", 12 },
                    { 3, 2, new DateTime(2026, 2, 9, 8, 40, 1, 444, DateTimeKind.Utc).AddTicks(5341), "100% organic cotton, comfortable fit for everyday wear", null, "/images/products/tshirt.jpg", true, null, "Premium Cotton T-Shirt", 24.99m, "CLO-TS-001", 150 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatusHistory_UpdatedBy",
                table: "OrderStatusHistory",
                column: "UpdatedBy");
